...
SECRET_KEY = "django-insecure-li9dy9!vsytnnb-=oy7c7p%@t=j-3n=u6=rwogd5htx&sa%)-="
...
INSTALLED_APPS = [
    'account.apps.AccountConfig', # placed first so templates used by default, ahead of preceeding apps
...
# FOR ADDING OUR OWN AUTHENTICATION CLASS
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend', # DEFUALT AUTHENTICATION
    'account.authentication.EmailAuthBackend', # Custom email auth class
